...
var HighlightedContext = React3.createContext({
  isInitialized: false,
  data: {
...
function HighlightedProvider({
  ...
  const seriesById = React4.useMemo(() => {
...
var ZAxisContext = React6.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React6.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
function useChartId() {
  ...
  return React9.useMemo(() => chartId, [chartId]);
}
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(animated.rect, {
...
function BarLabel(inProps) {
  ...
  return (0, import_jsx_runtime5.jsx)(BarLabelComponent, _extends({}, otherProps));
}
...
var AnimationContext = React15.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React16.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React17.useContext(AnimationContext);
  if (!isInitialized) {
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime9.jsxs)(React18.Fragment, {
    ...
    }), barLabel && (0, import_jsx_runtime9.jsx)(BarLabelPlot, _extends({
      bars: completedData,
      skipAnimation: skipAnimation2,
      barLabel
    }, other))]
...
function useChartGradient() {
  ...
  return React21.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React23.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React23.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};

// node_modules/@mui/x-charts/ChartContainer/useChartContainerProps.js
var _excluded8 = ["width", "height", "series", "margin", "xAxis", "yAxis", "zAxis", "colors", "dataset", "sx", "title", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "children", "skipAnimation"];
...
true ? ChartContainer.propTypes = {
   ...
   */
  plugins: import_prop_types7.default.arrayOf(import_prop_types7.default.object),
  /**
...
var _excluded9 = ["width", "height", "resolveSizeBeforeRender", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis", "skipAnimation"];
...
var ResponsiveChartContainer = React26.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
var Popper3 = React36.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
...
var _excluded14 = ["drawingArea", "seriesToDisplay", "hidden", "onItemClick"];
...
function ChartsLegend(inProps) {
  ...
  const {
    slots,
    slotProps
  } = defaultizedProps, other = _objectWithoutPropertiesLoose(defaultizedProps, _excluded15);
  const theme = useTheme();
...
var _excluded16 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter", "onItemClick"];
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime36.jsx)("clipPath", {
    id,
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime37.jsx)(React56.Fragment, {
    children: xTicks.map(({
      value,
      offset: offset2
    }) => (0, import_jsx_runtime37.jsx)(GridLine, {
      y1: drawingArea.top,
...
var _excluded17 = ["vertical", "horizontal"];
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime39.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime39.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      drawingArea,
      classes
    }), horizontal && (0, import_jsx_runtime39.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
      drawingArea,
      classes
    })]
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(React59.Fragment, {});
}
true ? ChartsOnAxisClickHandler.propTypes = {
   ...
   */
  onAxisClick: import_prop_types29.default.func
} : void 0;
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(StyledText, _extends({
    x: left2 + width / 2,
    y: top2 + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime42.jsx)(StyledText2, _extends({
    x: left2 + width / 2,
    y: top2 + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime43.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime43.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}

// node_modules/@mui/x-charts/BarChart/useBarChartProps.js
var _excluded20 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "axisHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className"];
...
var BarChart = React63.forwardRef(function BarChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime44.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime44.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime44.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime44.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime44.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime44.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime44.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime44.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime44.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime44.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime44.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? BarChart.propTypes = {
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types30.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
