...
import CreateExpense from '@/Pages/Expense/Partials/CreateExpense';
import DangerButton from '@/Components/DangerButton';
import Modal from '@/Components/Modal';
import SecondaryButton from '@/Components/SecondaryButton';
import { Head } from '@inertiajs/react';

const Index = ({ expenses, budgets }) => {
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <CreateExpense className="max-w-xl" budgets={budgets} />
                                        ...
                                        {expenses.map(expense => (
                                            <tr key={expense.id}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                                    ...
                                                    <DangerButton onClick={() => confirmExpenseDeletion(expense)}>
                                                        Delete Expense
                                                    </DangerButton>
                                                </td>
                                            </tr>
            ...
            <Modal show={confirmingExpenseDeletion} onClose={closeModal}>
                <form onSubmit={deleteExpense} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Once this expense is deleted, you cannot restore it. You will need to create a new expense again.
                    </p>
